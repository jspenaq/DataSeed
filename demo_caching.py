...
async def demo_caching():
    ...
    db1 = MockDB(item_count=100, last_updated=datetime(2024, 1, 1, 12, 0, 0, tzinfo=timezone.utc))
    db2 = MockDB(item_count=150, last_updated=datetime(2024, 1, 1, 13, 0, 0, tzinfo=timezone.utc))
    db3 = MockDB(item_count=100, last_updated=datetime(2024, 1, 1, 12, 0, 0, tzinfo=timezone.utc))  # Same as db1
