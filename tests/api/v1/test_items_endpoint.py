...
class TestItemsEndpoint:
    ...
    def test_get_items_filter_by_source_name(
        self,
        client: TestClient,
        test_items: list[ContentItem],
    ...
    def test_get_items_combined_filters_and_pagination(
        self,
        client: TestClient,
        test_items: list[ContentItem],
        test_sources: list[Source],
    ...
    @pytest.mark.asyncio
    async def test_get_items_with_null_content_and_score(
        self,
        client: TestClient,
